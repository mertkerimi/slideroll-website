...
export const translations: Record<LangCode, T> = {
  en: {
    ...
    languages: { label: 'Localization', heading: 'Speak your language.', sub: 'SlideRoll is available in 12 languages.' },
    ...
    cta: {
      ...
      sub: 'SlideRoll is on the App Store now.\nClean thousands of photos — in minutes.',
      cta: 'Download on the App Store',
  ...
  tr: {
    ...
    languages: { label: 'Yerelleştirme', heading: 'Kendi dilinizde konuşun.', sub: 'SlideRoll 12 dilde kullanılabilir.' },
  ...
  de: {
    ...
    languages: { label: 'Lokalisierung', heading: 'In Ihrer Sprache.', sub: 'SlideRoll ist in 12 Sprachen verfügbar.' },
    ...
    cta: {
      ...
      sub: 'SlideRoll ist jetzt im App Store.\nTausende Fotos — in Minuten aufgeräumt.',
      cta: 'Im App Store laden',
  ...
  fr: {
    ...
    languages: { label: 'Localisation', heading: 'Parlez votre langue.', sub: 'SlideRoll est disponible en 12 langues.' },
    ...
    cta: {
      ...
      sub: 'SlideRoll est maintenant sur l\'App Store.\nNettoyez des milliers de photos — en minutes.',
      cta: 'Télécharger sur l\'App Store',
  ...
  es: {
    ...
    languages: { label: 'Localización', heading: 'Habla tu idioma.', sub: 'SlideRoll está disponible en 12 idiomas.' },
    ...
    cta: {
      ...
      sub: 'SlideRoll ya está en el App Store.\nLimpia miles de fotos — en minutos.',
      cta: 'Descargar en el App Store',
  ...
  it: {
    ...
    languages: { label: 'Localizzazione', heading: 'Parla la tua lingua.', sub: 'SlideRoll è disponibile in 12 lingue.' },
  ...
  pt: {
    ...
    languages: { label: 'Localização', heading: 'Fale seu idioma.', sub: 'SlideRoll está disponível em 12 idiomas.' },
    ...
    cta: {
      ...
      sub: 'SlideRoll já está na App Store.\nLimpe milhares de fotos — em minutos.',
      cta: 'Baixar na App Store',
  ...
  ja: {
    ...
    languages: { label: 'ローカライズ', heading: 'あなたの言語で。', sub: 'SlideRollは12言語に対応。' },
    themes: { label: 'パーソナライズ', heading: '自分好みに。', sub: '10種類のカラーテーマとダークモード対応。' },
    cta: {
      heading: 'ストレージを\n取り戻す準備はできていますか？',
      sub: 'SlideRollはApp Storeで公開中。\n何千もの写真を数分でクリーンアップ。',
      cta: 'App Storeでダウンロード',
  ...
  ko: {
    ...
    languages: { label: '현지화', heading: '당신의 언어로.', sub: 'SlideRoll는 12개 언어로 제공됩니다.' },
    themes: { label: '개인화', heading: '나만의 스타일로.', sub: '10가지 아름다운 컬러 테마와 완전한 다크 모드 지원.' },
    cta: {
      heading: '저장 공간을\n되찾을 준비가 되셨나요?',
      sub: 'SlideRoll가 App Store에 출시되었습니다.\n수천 장의 사진을 몇 분 만에 정리하세요.',
      cta: 'App Store에서 다운로드',
  ...
  zh: {
    ...
    languages: { label: '本地化', heading: '使用您的语言。', sub: 'SlideRoll 提供 12 种语言版本。' },
    themes: { label: '个性化', heading: '打造专属风格。', sub: '10 款精美色彩主题，完整深色模式支持。' },
    cta: {
      heading: '准备好找回\n您的存储空间了吗？',
      sub: 'SlideRoll 现已在 App Store 上架。\n数千张照片 — 几分钟整理完毕。',
      cta: '在 App Store 下载',
      note: '免费 · 无需账号 · 支持离线使用',
    },
  ...
  ru: {
    ...
    languages: { label: 'Локализация', heading: 'Говорите на своём языке.', sub: 'SlideRoll доступен на 12 языках.' },
